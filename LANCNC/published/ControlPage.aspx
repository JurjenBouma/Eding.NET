...
<asp:Content ID="ControlContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="ButtonSim" runat="server" Height="113px" Text="ToggleSimMode" Width="138px" BackColor="#0066CC" Font-Names="Calibri" Font-Size="20pt" ForeColor="White" OnClick="ButtonSim_Click" />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
             ...
             <asp:Label ID="LabelSim" runat="server" BackColor="#003300" Font-Size="20pt" ForeColor="Yellow" Text="Running in simulation mode"></asp:Label>
            </ContentTemplate>
     </asp:UpdatePanel>
</asp:Content>
